...
Autonomously: engine.py:6030-6088 confirms and executes any idea at or above
...
(engine.py:6887) — its
result is handed to analyzer.analyze at :7056 as `basis` CONTEXT that votes on
...
trade gate whose whole enforcing set /enforcing lists. engine.py:6030-6088
...
realized win rate (engine.py:8970): the paper book's in paper mode, both
...
(bot/core/user_strategy_store.py:134-174), and bot/core/engine.py:7671-7720
...
bot/core/stock_trading.py, also read by bot/core/engine.py:8240
