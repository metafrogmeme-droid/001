...
Autonomously: engine.py:5460-5518 confirms and executes any idea at or above
...
(engine.py:6318) — its
result is handed to analyzer.analyze at :6487 as `basis` CONTEXT that votes on
...
trade gate whose whole enforcing set /enforcing lists. engine.py:5460-5518
...
(bot/core/user_strategy_store.py:108-148), and bot/core/engine.py:7098-7135
...
bot/core/stock_trading.py, also read by bot/core/engine.py:7648
