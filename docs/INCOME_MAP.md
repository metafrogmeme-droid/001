...
bot/core/live_executor.py:6695 (the per-strategy trailing switch read at the fill).
...
live_executor.py:5603 creates the entry order idempotently, :7097/:7538 attach
the exchange-side stop and take-profit, and every venue call carries
productType USDT-FUTURES (:2007, :2023, :2150); venues.py:283 selects the swap
