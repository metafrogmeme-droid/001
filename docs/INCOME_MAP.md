...
bot/core/live_executor.py:7011 (the per-strategy trailing switch read at the fill).
...
live_executor.py:5889 creates the entry order idempotently, :7413/:7881 attach
the exchange-side stop and take-profit, and every venue call carries
productType USDT-FUTURES (:2175, :2191, :2319); venues.py:340 selects the swap
