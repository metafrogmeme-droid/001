...
The Guardian command group (/policy, /twin, /sentinel, /escape, /guardian,
/approvals, /xray and the policy-bind callback) is a mixin in
bot/skills/guardian_commands.py that this class inherits;
`tests/test_guardian_commands_split.py` pins that one.
"""
...
class TelegramHandler(GuardianCommands):
