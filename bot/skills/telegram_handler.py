...
account, market, research, agent, engine_ops, portfolio and scan so far. `tests/test_handler_mixins.py`
...
from bot.skills.scan_hints import (_background_scan_is_fresh, _scan_timeout_hint,
