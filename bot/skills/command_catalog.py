...
GROUPS: List[Group] = [
    ...
    ("📈 Trading", "user", [
        ...
        ("arbpair", "size a delta-neutral funding pair over your linked venues — "
                    "/arbpair BTC [usd]; a proposal that places nothing"),
    ...
    ("🔎 Scan & analyse", "user", [
        ...
        ("pocshadow", "what the recorded POC-retest setups paid"),
...
DESC_ZH: Dict[str, str] = {
    ...
    "rwa": "代幣化實體資產雷達", "crossasset": "跨資產相關性背景",
    ...
    "watch": "為此對話開啟主動提醒", "alerts": "異常警報範圍與頻率",
    "price_alert": "在此設定價格提醒，觸發時會傳到這裡", "share": "儲存一則代理可參考的筆記",
