...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "lbl_sltp_monitor": {"en": "SL/TP monitor", "zh": "止損／止盈監控"},
    "val_sltp_ran": {"en": "ran this tick", "zh": "本次循環已執行"},
    "val_sltp_backstop": {"en": "tick ended early — back-stop watched the stops",
                          "zh": "循環提前結束 — 由後備機制看守止損"},
    "val_sltp_unwatched": {"en": "DID NOT RUN — open positions unwatched",
                           "zh": "未執行 — 持倉無人看守"},
    "val_sltp_backstop_failed": {"en": "back-stop FAILED — open positions unwatched",
                                 "zh": "後備機制失敗 — 持倉無人看守"},
    ...
    "val_signals_done": {"en": "signals attempted before it was cancelled",
                         "zh": "在取消前已嘗試分析的訊號"},
    "val_analysed": {"en": "analysed",
                   "zh": "已分析"},
    "val_gave_up_short": {"en": "gave up at the per-symbol cap",
                        "zh": "達單一標的上限而放棄"},
    "val_errored": {"en": "failed with an error",
                  "zh": "因錯誤失敗"},
    "val_cancelled": {"en": "still running when the phase was cancelled",
                    "zh": "階段取消時仍在執行"},
