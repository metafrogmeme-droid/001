 ...
 */
//
// UMD, so ONE implementation serves Node and the browser. The alternative —
// a browser copy alongside the server copy — is the exact defect this file
// was written about, one level over: two implementations of the same digest,
// drifting silently, with no way to tell from either output which one you
// got. `app/lib/keccak256.js` re-exports this; `register-tool.html` loads it
// with a script tag; both get the same bytes.
(function (root, factory) {
  const api = factory();
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  else root.Keccak256 = api;
...
function keccak256Utf8(str) {
  ...
  return { keccak256, keccak256Utf8, toUtf8Bytes, hexlify, selfTest, VECTORS, RATE, PAD_BYTE };
}));
