...
(function (root) {
  ...
  var STRINGS = {
    ...
    'dd.err_lab': { en: 'Strategy Lab unavailable.', es: 'Laboratorio de estrategias no disponible.', zh: '策略實驗室無法使用。', pt: 'Laboratório de estratégias indisponível.', fr: 'Labo de stratégies indisponible.', ar: 'مختبر الاستراتيجيات غير متاح.' },
    'dd.err_agents': { en: 'The agent catalogue is unavailable right now.', es: 'El catálogo de agentes no está disponible ahora.', zh: '代理目錄目前無法取得。', pt: 'O catálogo de agentes está indisponível agora.', fr: 'Le catalogue d\'agents est indisponible pour le moment.', ar: 'دليل الوكلاء غير متاح حاليًا.' },
    'dd.cta_tg': { en: 'Link Telegram', es: 'Vincular Telegram', zh: '連結 Telegram', pt: 'Vincular Telegram', fr: 'Lier Telegram', ar: 'اربط تيليجرام' },
    'dd.cta_login': { en: 'Log in or create an account', es: 'Inicia sesión o crea una cuenta', zh: '登入或建立帳戶', pt: 'Entre ou crie uma conta', fr: 'Connectez-vous ou créez un compte', ar: 'سجّل الدخول أو أنشئ حسابًا' },
    'dd.cta_ticket': { en: 'Open the trade ticket', es: 'Abrir la boleta de orden', zh: '開啟下單單據', pt: 'Abrir a boleta de ordem', fr: 'Ouvrir le ticket d\'ordre', ar: 'افتح تذكرة الأمر' },
    'dd.cta_paper': { en: 'Place a paper trade', es: 'Haz una operación en papel', zh: '進行一筆模擬交易', pt: 'Faça uma operação simulada', fr: 'Passer un trade papier', ar: 'نفّذ صفقة ورقية' },
    'dd.cta_verify': { en: 'Resend verification', es: 'Reenviar verificación', zh: '重新發送驗證', pt: 'Reenviar verificação', fr: 'Renvoyer la vérification', ar: 'أعد إرسال التحقق' },
    'dd.cta_live': { en: 'Review live controls', es: 'Revisar controles en vivo', zh: '檢視實盤控制', pt: 'Revisar controles ao vivo', fr: 'Vérifier les contrôles live', ar: 'راجع أدوات التحكم المباشر' },
    'dd.e_portfolio': { en: 'No portfolio data yet.', es: 'Aún no hay datos de cartera.', zh: '尚無投資組合數據。', pt: 'Ainda não há dados de portfólio.', fr: 'Pas encore de données de portefeuille.', ar: 'لا توجد بيانات محفظة بعد.' },
    'dd.e_positions': { en: 'No open positions. The Trade view has a full order ticket.', es: 'Sin posiciones abiertas. La vista Trade tiene una boleta completa.', zh: '目前沒有持倉。交易頁面有完整的下單單據。', pt: 'Sem posições abertas. A view Trade tem uma boleta completa.', fr: 'Aucune position ouverte. La vue Trade contient un ticket complet.', ar: 'لا توجد مراكز مفتوحة. تحتوي صفحة التداول على تذكرة أمر كاملة.' },
    'dd.e_signals': { en: 'No signals yet — they appear as the engine scans.', es: 'Aún no hay señales — aparecen mientras el motor escanea.', zh: '尚無訊號——引擎掃描時會出現。', pt: 'Ainda sem sinais — aparecem conforme o motor varre.', fr: 'Pas encore de signaux — ils apparaissent au fil des scans.', ar: 'لا إشارات بعد — تظهر أثناء مسح المحرك.' },
    'dd.e_macro': { en: 'The macro backdrop appears once market data is available.', es: 'El contexto macro aparece cuando hay datos de mercado.', zh: '市場數據可用後即顯示宏觀背景。', pt: 'O pano de fundo macro aparece quando houver dados de mercado.', fr: 'Le contexte macro apparaît dès que les données de marché arrivent.', ar: 'تظهر الخلفية الكلية عند توفر بيانات السوق.' },
    'dd.e_agent': { en: 'Agent status unavailable right now.', es: 'Estado del agente no disponible ahora.', zh: '代理狀態目前無法取得。', pt: 'Status do agente indisponível agora.', fr: 'Statut de l\'agent indisponible pour le moment.', ar: 'حالة الوكيل غير متاحة حاليًا.' },
    'dd.e_letter': { en: 'The first letter writes itself after the first full week of recorded activity.', es: 'La primera carta se escribe sola tras la primera semana completa de actividad registrada.', zh: '第一封信會在完整記錄一週活動後自動生成。', pt: 'A primeira carta se escreve após a primeira semana completa de atividade registrada.', fr: 'La première lettre s\'écrit après une première semaine complète d\'activité enregistrée.', ar: 'تُكتب الرسالة الأولى بعد أول أسبوع كامل من النشاط المسجَّل.' },
